...
def generate_launch_description():
    ...
    # )
    # world_path = os.path.expanduser('~/ws/mia_ws/src/multirobot-sim-ros2/champ/champ_gazebo/worlds/restaurant.world')
    ...
    gazebo_server = ExecuteProcess(
        cmd=[
            ...
            os.path.expanduser('~/ws/mia_ws/src/multirobot-sim-ros2/champ/champ_gazebo/worlds/cafe.world'),
        ],
        output="screen",
    )
    ...
    robots = [
            {'name': 'arm1', 'x_pose': '-1.3', 'y_pose': '3.6', 'z_pose': '1.34' , 'Y':'0.0'},
            {'name': 'arm2', 'x_pose': '1.0', 'y_pose': '-1.54', 'z_pose': '0.94' , 'Y':'0.0'},
...
def spawn_robot(
    ...
    robot_doc = xacro.process_file(
        ...
        mappings={
            ...
            "safety_limits": "true",
            "prefix": robot_name + "_",  # Example: arm1_
            "pedestal_height": "0.1",
        },
    )
