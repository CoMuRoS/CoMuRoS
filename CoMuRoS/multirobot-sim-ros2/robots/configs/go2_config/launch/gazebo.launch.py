...
def generate_launch_description():
    ...
    declare_world_init_x = DeclareLaunchArgument("world_init_x", default_value="-0.470729")
    declare_world_init_y = DeclareLaunchArgument("world_init_y", default_value="3.510111")
    declare_world_init_z = DeclareLaunchArgument("world_init_z", default_value="0.575")
