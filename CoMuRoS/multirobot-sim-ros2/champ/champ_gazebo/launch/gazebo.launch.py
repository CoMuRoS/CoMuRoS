...
def generate_launch_description():
    ...
    declare_world_init_x = DeclareLaunchArgument("world_init_x", default_value="9.602375")
    declare_world_init_y = DeclareLaunchArgument("world_init_y", default_value="1.634334")
    declare_world_init_z = DeclareLaunchArgument("world_init_z", default_value="1000.6")
    declare_world_init_heading = DeclareLaunchArgument(
        "world_init_heading", default_value="1.5"
    )
