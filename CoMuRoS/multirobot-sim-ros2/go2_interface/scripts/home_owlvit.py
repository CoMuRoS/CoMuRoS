...
class OwlViTDetectionNode(Node):
    def __init__(self):
        super().__init__('arm_owlvit_detection_node')
        ...
        self.subscription = self.create_subscription(
            CompressedImage,
            '/arm2/depth_camera_sensor/image_raw/compressed',
            self.image_callback,
            qos_profile)
        ...
        self.detection_publisher = self.create_publisher(
            Detection2DArray,
            '/arm2/owlvit_detections',
            10)

        self.img_publisher = self.create_publisher(
            CompressedImage,
            '/arm2/image_processed/compressed',
            10)
        ...
        self.synonym_groups = {
            # "robot dog": [
            #     "a dog robot",
            #     "gray robot with Go2 written on it",
            #     "aruco marker",
            #     "a dog",
            #     "close up view of gray dog robot",
            #     "a robot dog",
            #     "a four legged robot",
            #     "a robot that looks like a dog",
            #     "unitree go 2 robot"
            # ],        
            "food": [
                "breakfast sandwich",
                ...
                "green color food",
                "food in white plate",
                "banana in white plate",
                "round white plate",
                "mixed green salad with sourdough bread on a white plate",
                "leafy salad with crusty bread slice on wooden table",
                "plate of fresh greens and artisan bread",
                "salad and bread meal served on white ceramic plate",
                "healthy green salad with rustic bread on wood surface",
            ...
            "robot dog": [
                ...
                "a dog like metallic robot",
                # "a metallic robot resembling a dog",
                # "a metallic robot resembling a sitting dog",
                # "close up view Go2",
                # "monochrome gray dog",
                # "a gray dog with orange plate on the back",
                # "a gray robot that looks like a mechanical dog",
                # "a sitting quadruped",
                # "a quadruped"
            ...
            # "orange plate": [
            #     "bright orange cuboid",
            #     "solid orange block",
            #     "orange rectangular slab",
            #     "orange-colored flat object",
            #     "orange cuboid platform",
            #     "orange rectangular prism",
            #     "orange flat plate",
            #     "orange-colored cuboid",
            #     "tangerine-hued plate",
            #     "burnt orange serving tray",
            #     "amber-toned dish",
            #     "cantaloupe-colored platter",
            #     "rust-colored flatware",
            #     "coral-tinted plate",
            #     "sunset-orange dish",
            #     "copper-toned serving board",
            #     "marmalade-colored plate",
            #     "carrot-colored tray",
            #     "apricot-hued platter",
            #     "saffron-colored dish"
            # ],
            "ur5" : [
                "ur5 robotic arm",
                # "robotic manipulator",
            ...
            # "a green object": [
            #     "a monochromatic green object",
            #     "a monochromatic green ball",
            ...
            #     "a chair",
            #     "sitting thing",
            #     "a black seat with silver ring",
            #     "an office chair or dining chair",
            #     "a single-person seat",
            # ],
            "table":[
                # "a wooden ",
                "metal table",
            ...
            # "box" : [
            #     "a cardboard",
            #     "a storage box made of cardboard",
            #     "a parcel or shipping box",
            #     "a rectangular container for packaging"
            # ],
            # "arm mounted robot": [
            #     "arm mounted robot",
            #     "a large black robot with black robotic arm",
            #     "robotic arm on mobile robot",
            #     "mobile manipulator",
    ...
    def image_callback(self, msg):
        ...
        try:
            ...
            # Now you can process cv_image with OpenCV
        ...
        for group_label, det_list in grouped_detections.items():
            custom_threshold = 0.05  # Adjust per group if necessary.
    ...
    def display_image(self):
        cv2.namedWindow("Waffle OwlViT", cv2.WINDOW_NORMAL)
        while rclpy.ok():
            with self.lock:
                if self.processed_frame is not None:
                    cv2.imshow("Waffle OwlViT", self.processed_frame)
                    cv2.waitKey(1)
